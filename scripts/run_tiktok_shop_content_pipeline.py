#!/usr/bin/env python3
"""
Manual / CI trigger for TikTok Shop content pipeline with dual-layer inventory intelligence.

Runs: predictive layer → content mode resolver → content generation → reactive gate.
Does not modify trends.py.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run TikTok Shop dual-layer content pipeline",
    )
